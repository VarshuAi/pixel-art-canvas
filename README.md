...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/pixel-art-canvas.git
   cd pixel-art-canvas
   ```
...
[![Repo](https://img.shields.io/badge/pixel-art-canvas-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/pixel-art-canvas)
